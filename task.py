...
#
# -Код не должен содержать "запасных" методов на будущее. Делаем только то, что требуется
#  для поставленной задачи.
#
# -Классы (если имеются) и сложные методы должны иметь комментарии в формате docstrings
